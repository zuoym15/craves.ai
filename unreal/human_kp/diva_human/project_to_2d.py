...
from json_reader import read_jsonlist
from projection import CamPose
import numpy as np
...
class CocoDatasetBuilder:
    ...
    def add(self, frame_id, im_filename, sensor_filename, kp_filename):
        sensors = parse_sensor_file(sensor_filename)
        humans = parse_3d_kps(kp_filename) 
...
def parse_sensor_file(sensor_filename):
